...
export const windowEffectsMeta: SectionMeta = {
  ...
  fields: [
    ...
    { configKey: "blur_params_num_passes", label: "Blur Passes",   description: "Number of blur iterations",        aliases: ["iterations", "quality"] },
    { configKey: "blur_params_radius",     label: "Blur Radius",   description: "Pixel radius of the blur kernel",  aliases: ["size", "spread"] },
    ...
    { configKey: "border_radius",  label: "Border Radius",         description: "Corner rounding in pixels",        aliases: ["rounded", "corners", "rounding"] },
    { configKey: "border_radius_location_default", label: "Affected Corners", description: "Which corners receive the radius" },
    { configKey: "focused_opacity",   label: "Focused Opacity",    description: "Opacity of the currently focused window",    aliases: ["transparency", "alpha"] },
    { configKey: "unfocused_opacity", label: "Unfocused Opacity",  description: "Opacity of unfocused background windows",    aliases: ["transparency", "alpha"] },
    ...
    { configKey: "shadows_blur",      label: "Shadow Softness",    description: "Gaussian blur sigma for softer shadows",     aliases: ["feather"] },
