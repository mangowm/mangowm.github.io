...
export const SECTIONS: SectionDef[] = [
    ...
    fields: [
      {
        configKey: "exec-once",
        label: "exec-once",
        description: "Commands that run only once on compositor launch",
      },
      {
        configKey: "exec",
        label: "exec",
        description: "Commands that execute on every config reload",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      {
        configKey: "new_is_master",
        label: "New Windows as Master",
        description: "New windows open in the master area instead of the stack",
      },
      {
        configKey: "default_mfact",
        label: "Master Area Factor",
        description: "Proportion of screen width allocated to the master area",
      },
      {
        configKey: "default_nmaster",
        label: "Number of Masters",
        description: "How many windows are kept in the master area",
      },
      {
        configKey: "center_master_overspread",
        label: "Center Master Overspread",
        description: "Center the master window when it overspreads",
      },
      {
        configKey: "center_when_single_stack",
  ...
  },
  {
    ...
    fields: [
      {
        configKey: "dwindle_vsplit",
        label: "Vertical Split",
        description: "Policy for vertical splits in the dwindle layout",
      },
      {
        configKey: "dwindle_hsplit",
        label: "Horizontal Split",
        description: "Policy for horizontal splits in the dwindle layout",
      },
      {
        configKey: "dwindle_preserve_split",
        label: "Preserve Split",
        description: "Keep the current split direction when inserting",
      },
      {
        configKey: "dwindle_smart_split",
        label: "Smart Split",
        description: "Auto-choose split direction based on dimensions",
      },
      {
        configKey: "dwindle_smart_resize",
        label: "Smart Resize",
        description: "Intelligently resize adjacent windows",
      },
      {
        configKey: "dwindle_drop_simple_split",
        label: "Drop Simple Split",
        description: "Fall back to simple split when smart split can't decide",
      },
      {
        configKey: "dwindle_manual_split",
        label: "Manual Split",
        description: "Require explicit split direction input",
      },
      {
        configKey: "dwindle_split_ratio",
        label: "Split Ratio",
        description: "Proportion of space for the first child when splitting",
      },
    ],
  },
  {
