...
export const RULE_MATCHER_OPTIONS: Record<string, { value: string; label: string }[]> = {
  layout_name: [
    ...
    { value: "scroller", label: "Horizontal Scroller" },
    { value: "grid", label: "Grid" },
    { value: "monocle", label: "Monocle" },
    { value: "deck", label: "Deck" },
    { value: "center_tile", label: "Centered Master" },
    { value: "right_tile", label: "Right-side Master" },
    ...
    { value: "fair", label: "Fair Split" },
    { value: "vertical_fair", label: "Vertical Fair Split" },
  ],
  id: [
    { value: "0", label: "0" },
    { value: "1", label: "1" },
